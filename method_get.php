...
<body>
    ...
    <div class="main-frame-cal">
        <!--Se cambia method="POST" POR method="GET" -->
        <form action="" method="GET">
        <div><label for="exampleFormControlInput1">Escriba su nombre y numero de identificación:</label></div>
        ...
        if (isset($_GET['verificar'])) {
            $nombre = $_GET['nombre'];
            # Se cambia method="POST" POR method="GET" de apellido.
